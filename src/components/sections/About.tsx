  ...
  return (
    <Section id="about" className='relative ' noColumns={false}>
      <motion.div
        ...
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }} className="max-w-prose text-left">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }} className="mt-4 flex gap-4 sm:mt-6">
      ...
      <motion.img
        ...
        whileInView="visible"
        viewport={{ once: true }}
        src={CoffeBlastLeft} alt="grãos de café" className=' md:block absolute left-0 -bottom-10 pointer-events-none w-1/2 sm:w-2/3 md:max-w-1/4 h-auto' />
    </Section>
