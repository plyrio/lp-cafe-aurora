...
export const Actions = () => {
  return (
    <>
      ...
      <Button type="submit" variant="default" className='rounded-l-none  h-full border-none text-stone-900 bg-orange-300 rounded-3xl hover:bg-orange-200 w-fit mx-auto'>
        Registrar
      </Button>
